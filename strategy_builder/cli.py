...
def build_parser() -> argparse.ArgumentParser:
    ...
    optimize.add_argument("--reasoning-effort", choices=["minimal", "low", "medium", "high"], default=None)
    optimize.add_argument("--verbosity", choices=["low", "medium", "high"], default=None)
    optimize.add_argument("--max-output-tokens", type=int, default=0)
    ...
    compose.add_argument("--reasoning-effort", choices=["minimal", "low", "medium", "high"], default=None)
    compose.add_argument("--verbosity", choices=["low", "medium", "high"], default=None)
    compose.add_argument("--max-output-tokens", type=int, default=0)
